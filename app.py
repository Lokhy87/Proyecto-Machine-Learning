...
if not os.path.isfile(rf_mod):
    ...
    # Aplicar estilo CSS para fondo y centrar el contenido
    st.markdown(
        """
        <style>
        .centered {
        ...
        .portada {
            background-image: url('https://example.com/path-to-portada.jpg');  /* URL de la imagen de fondo de la portada */
            background-size: cover;
            background-position: center;
        }
        .eda {
            background-image: url('https://example.com/path-to-eda.jpg');  /* URL de la imagen de fondo del EDA */
            background-size: cover;
            background-position: center;
        }
        .simulador {
            background-image: url('https://example.com/path-to-simulador.jpg');  /* URL de la imagen de fondo del simulador */
            background-size: cover;
            background-position: center;
        }
        </style>
    ...
    if not st.session_state.entrar:
        with st.container():
            st.markdown('<div class="centered portada">', unsafe_allow_html=True)
        ...
        # Pestaña EDA
        with tabs[0]:
            st.markdown('<div class="eda">', unsafe_allow_html=True)
        ...
        # Pestaña Simulador
        with tabs[1]:
            st.markdown('<div class="simulador">', unsafe_allow_html=True)
